...
| Mac with Apple silicon, macOS 14+ — as a **host** (self-signed proof, see notes) | [AppBridge Host 0.1.0 for macOS (arm64)](https://github.com/skyflyt/appbridge-releases/releases/tag/v0.1.0-macos) |
...
The Mac build is a self-signed proof: right-click Open on first launch, click Always Allow once for its Keychain key, grant Screen Recording and Accessibility, then reopen it. Full notes are on its release page.
