...
| Mac with Apple silicon, macOS 14+ — as a **host** (self-signed, see notes) | [Back Channel Remote 0.2.0 for macOS (arm64)](https://github.com/skyflyt/appbridge-releases/releases/tag/v0.2.0-macos) |
| Release notes and checksums | [x64: Version 1.1.4.0 Setup](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.4.0) → in-app updates [1.1.7.0-x64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.7.0-x64), [1.1.8.0-x64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.8.0-x64), [1.1.12.0-x64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.12.0-x64) · [ARM64: Version 1.1.5.0-arm64 Setup](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.5.0-arm64) → in-app updates [1.1.6.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.6.0-arm64), [1.1.8.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.8.0-arm64), [1.1.10.1-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.10.1-arm64), [1.1.15.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.15.0-arm64), [1.1.17.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.17.0-arm64), [1.1.19.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.19.0-arm64), [1.1.21.0-arm64](https://github.com/skyflyt/appbridge-releases/releases/tag/v1.1.21.0-arm64) |

The Mac build is self-signed: right-click Open on first launch, click Always Allow once for its Keychain key, grant Screen Recording and Accessibility, then reopen it. Upgrading from 0.1.0 is a replace of the app; pairings carry over. Full notes are on its release page.
